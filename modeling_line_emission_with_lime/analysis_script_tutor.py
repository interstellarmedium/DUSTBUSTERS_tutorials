...
my_model_fits = 'HC3N_image_29-28.fits'
my_model_fits = 'HC3N_image_11-10.fits'
...
my_model_image = 'HC3N_image_29-28.fits.im.smooth'
my_model_image = 'HC3N_image_11-10.fits.im.smooth'
...
for infile in [my_model_image+'.mom0', my_model_image+'.mom1', my_model_image+'.mom2', my_model_image+'.mom8']:
...
my_model_fits = 'HC3N_image_29-28.fits.im.smooth.fits'
my_model_fits = 'HC3N_image_11-10.fits.im.smooth.fits'
...
mom0_cmd = "bettermoments " + my_model_fits + " -method first"
mom0_cmd = "bettermoments " + my_model_fits + " -method second"
mom0_cmd = "bettermoments " + my_model_fits + " -method eighth"
os.system(mom0_cmd)
...
flux_region    = 'circle[[%sdeg, %sdeg], %.1farcsec]' % (0.0,0.0,4.0)
...
specflux(imagename=my_model_image,
	region = flux_region,
	logfile='HC3N_image_29-28.flux')

specflux(imagename=my_model_image,
	region = flux_region,
	logfile='HC3N_image_11-10.flux')
...
# Model 1
# HD 163296 HC3N 29-28 => 0.907 Jy.km/s
# HD 163296 HC3N 11-10 => 0.835 Jy.km/s

# Model 2
# HD 163296 HC3N 29-28 => 0.488 Jy.km/s 
# HD 163296 HC3N 11-10 => 1.234 Jy.km/s 


# Compare these with the values from Ilee et al. (2021)

# HD 163296 HC3N 11-10 => 0.129 ± 0.0056 mJy km/s
# HD 163296 HC3N 29-28 => 0.197 ± 0.0030 mJy km/s
...
radius = 4              # distance out to which to stack in disk, arcsec
...
inclination = 46.7     # degrees, 90 = edge on 
PA = 313.3             # degrees (red lobe, measured east from north)
